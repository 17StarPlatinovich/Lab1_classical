import java.lang.Math; //Импорт математических функций от джавака
import java.util.Arrays; //Импорт функций для создания массивов от джавака

public class Lab1 {
    public static void main(String[] args) {
        short[] c = new short[13]; //создание массива c типа short (целые числа от -32768 до 32767) с 13-ью элементами
        short i; //объявление переменного i; обозначает индексы элементов массива с
        for (i = 0; i < c.length; i++) { //создание условий для элементов массива с
            ...
            ++i;
            System.out.println(Arrays.toString(c)); //процесс печатания конечного массива c
        }
        ...
        int j;//объявление переменного j; обозначает индексы элементов массива x
        for (j = 0; j < x.length; j++) { //создание условий для элементов массива x
            ...
            System.out.println(Arrays.toString(x));//процесс печатания конечного массива x
        }
        ...
        double pi = 3.14159; //введение значения π, т.к. в джаваке нет такого данного
        for (i = 0; i < c.length; i++) { //создание условий для элементов матрицы d; допёрся до этого после 5 дней
            for (j = 0; j < x.length; j++) {
                ...
                System.out.printf("%9.5f", d[i][j]); //вывод результата в формате с пятью знаками после запятой
            }
